...
\uncover<+->{\[
\E[Y_i \mid X_{[1]i}, X_{[2]i}]
= \beta_0 + \beta_1 \mathbf{1}\{X_{[1]i}=B\} + \beta_2 X_{[2]i}.
\]}
\begin{wideitemize}
...
\[
\E[Y_i \mid X_{[1]i}, X_{[2]i}]
= \beta_0 + \beta_2 \mathbf{1}\{X_{[1]i}=B\} + \beta_3 X_{[2]i}.
\]
\end{frame}
...
= \beta_0 + \beta_1 D_i + \beta_2 \mathbf{1}\{X_{[1]i}=B\} + \beta_3 X_{[2]i}.
\]
\begin{wideitemize}
...
\item If you want the \textbf{total effect} ($\Pr[Y|do(D=d)]$), $M$ is not in a backdoor adjustment set.
...
\end{wideitemize}
\item Conditioning on $C$ does \emph{not} identify a direct effect here—it creates bias.
\end{wideitemize}
\end{frame}
...
%-------------------------------------------------------------------------------%
\begin{frame}[shrink=14]{Science table: hot deck imputation (propensity score)}
...
$i$ & $X_{[1]i}$ & $X_{[2]i}$ & $p_D(X_i)$ & $Y_i(0)$ & $Y_i(1)$ & \textcolor{Violator1}{$D_i$} & \textcolor{Violator1}{$Y_i$} \\
\cmidrule(lr){1-1}\cmidrule(lr){2-6}\cmidrule(lr){7-8}
1 & A & 0 & \cellcolor{Contrast2l}0.33 & 0 & \textcolor{red!40}{\textit{donor}} & \textcolor{Violator1}{0} & \textcolor{Violator1}{0} \\
2 & A & 0 & \cellcolor{Contrast2l}0.33 & \textcolor{red!40}{\textit{donor}} & 1 & \textcolor{Violator1}{1} & \textcolor{Violator1}{1} \\
3 & B & 0 & \cellcolor{Contrast6l}0.50 & 1 & \textcolor{red!40}{\textit{donor}} & \textcolor{Violator1}{0} & \textcolor{Violator1}{1} \\
4 & B & 0 & \cellcolor{Contrast6l}0.50 & \textcolor{red!40}{\textit{donor}} & 1 & \textcolor{Violator1}{1} & \textcolor{Violator1}{1} \\
5 & A & 1 & \cellcolor{Contrast6l}0.50 & 0 & \textcolor{red!40}{\textit{donor}} & \textcolor{Violator1}{0} & \textcolor{Violator1}{0} \\
6 & A & 1 & \cellcolor{Contrast6l}0.50 & \textcolor{red!40}{\textit{donor}} & 1 & \textcolor{Violator1}{1} & \textcolor{Violator1}{1} \\
7 & B & 1 & \cellcolor{Contrast4l}0.67 & 1 & \textcolor{red!40}{\textit{donor}} & \textcolor{Violator1}{0} & \textcolor{Violator1}{1} \\
8 & B & 1 & \cellcolor{Contrast4l}0.67 & \textcolor{red!40}{\textit{donor}} & 0 & \textcolor{Violator1}{1} & \textcolor{Violator1}{0} \\
9 & A & 0 & \cellcolor{Contrast2l}0.33 & 1 & \textcolor{red!40}{\textit{donor}} & \textcolor{Violator1}{0} & \textcolor{Violator1}{0} \\
10 & B & 1 & \cellcolor{Contrast4l}0.67 & \textcolor{red!40}{\textit{donor}} & 1 & \textcolor{Violator1}{1} & \textcolor{Violator1}{1} \\
\end{tabular}
\end{table}
