...
\only<3>{\textcolor{Contrast2}{\underbrace{\color{black}\left[
\frac{D_i\left(Y_i-\only<2>{\textcolor{Contrast1}}{\hat m_1(\X_i)}\right)}{\textcolor{Contrast2}{\hat p_D(\X_i)}}
-\frac{(1-D_i)\left(Y_i-\only<2>{\textcolor{Contrast1}}{\hat m_0(\X_i)}\right)}{\textcolor{Contrast2}{1-\hat p_D(\X_i)}}
\right]}_{\text{residual correction}}}}
\end{aligned}
\]
