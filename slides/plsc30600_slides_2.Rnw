...
\end{align*}
\[
= \textcolor{Contrast2}{\frac{3}{10}\cdot 0.5} + \textcolor{Contrast6}{\frac{2}{10}\cdot 0}
 + \textcolor{Contrast6}{\frac{2}{10}\cdot 1} + \textcolor{Contrast4}{\frac{3}{10}\cdot 1}
= 0.5
\]\pause
\[
\widehat{\E}[\tau_i] = 0.85 - 0.65 = 0.35
\]
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width = 0.8\textwidth]{\plscassetpath/wiki_beta.png}
\end{figure}
\end{frame}
%-------------------------------------------------------------------------------%\begin{frame}{AMCE}
\begin{frame}{AMCE}
