...
You will be sent a private invite to join the forum at the start of the quarter. 
...
\paragraph{Sweave.} To more easily create documents that combine R code and prose, we will compile assignments using Sweave (\url{https://support.posit.co/hc/en-us/articles/200552056-Using-Sweave-and-knitr}). Sweave requires you to have a \LaTeX{} distribution installed on your machine (\url{https://www.latex-project.org/get/}). You should familiarize yourself with creating and compiling Sweave documents before your first lab meeting.
...
\begin{itemize}
\item \bibentry{holland_1986}
\item Hernán and Robins, Section 1
\item Aronow \& Miller, Sections 6.1.1--6.1.3 and 7.1.1--7.1.2
\end{itemize}
...
\textbf{Problem Set 1 assigned TBA, due TBA}
...
\textbf{Problem Set 2 assigned TBA, due TBA}
...
\textbf{Midterm Exam assigned TBA, due TBA}
...
\textbf{Problem Set 3 assigned TBA, due TBA}
...
\textbf{Take-home final assigned TBA, due TBA}
...
\textbf{In-class final exam during exam xeek (March 10 -- March 13)}
